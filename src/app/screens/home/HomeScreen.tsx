...
import { formatNumber, formatPlayTime } from '../../shared/formatters';
...
import { CombatProgression, ProfessionProgression } from './ProgressionPanels';
      ...
      <UiPanelGrid screen="home" className="home-panel-grid">
        ...
        <UiPanelSlot screen="home" id="homeCombatProgression" layout={uiLayout}>
          <div className="home-progression-panel-wrap">
            <CombatProgression game={game} onNavigate={onNavigate} uiLayout={uiLayout} />
          </div>
        </UiPanelSlot>
        <UiPanelSlot screen="home" id="homeProfessionProgression" layout={uiLayout}>
          <div className="home-progression-panel-wrap">
            <ProfessionProgression game={game} onNavigate={onNavigate} uiLayout={uiLayout} />
          </div>
        </UiPanelSlot>
        <UiPanelSlot screen="home" id="homeWorldRecord" layout={uiLayout}>
          <WorldRecord record={worldRecord} onNavigate={onNavigate} uiLayout={uiLayout} />
        </UiPanelSlot>
      </UiPanelGrid>
    </div>
  );
...
function WorldRecord({
  ...
  return (
    <section className="panel panel-pad home-world-record" aria-labelledby="world-record-title">
      <UiPanelRegionGrid screen="home" panelId="homeWorldRecord" layout={uiLayout} className="home-world-record-layout">
        <UiPanelRegionSlot
          screen="home"
          panelId="homeWorldRecord"
          regionId="homeWorldRecordHeading"
          layout={uiLayout}
          className="home-world-record-heading-region"
        >
        ...
        <UiPanelRegionSlot
          screen="home"
          panelId="homeWorldRecord"
          regionId="homeWorldRecordLifetimeStats"
          layout={uiLayout}
          className="home-world-record-lifetime-region"
        >
        ...
        <UiPanelRegionSlot
          screen="home"
          panelId="homeWorldRecord"
          regionId="homeWorldRecordCollection"
          layout={uiLayout}
          className="home-world-record-collection-region"
        >
